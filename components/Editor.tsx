  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-8 space-y-12 animate-in fade-in zoom-in-95 duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 sticky top-20 z-40 bg-slate-50/90 backdrop-blur-md py-4 border-b border-slate-200 mb-8">
        <div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">Editor Visual Nova</h2>
          <p className="text-slate-500 font-medium">Refina el contenido y la estructura de tu presentación.</p>
        </div>
      ...
      <section className="space-y-8 bg-white p-10 rounded-[3rem] border border-slate-100 shadow-xl">
        ...
        <div className="grid gap-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-400 ml-1">Subtítulo Estratégico</label>
            <input 
      ...
      <section className="space-y-8">
        <div className="flex justify-between items-center">
          <h3 className="text-xs font-black text-indigo-600 uppercase tracking-widest">Estructura de Diapositivas ({editedP.slides.length})</h3>
          <button 
            onClick={addSlide}
      ...
      <div className="pt-12 text-center">
         ...
         >
           Finalizar y Guardar Presentación
         </button>
      </div>
    </div>
  );
